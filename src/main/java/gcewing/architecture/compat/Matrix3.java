...
public class Matrix3 {
    ...
    public static final Matrix3[] turnRotations = { rotY(0), rotY(90), rotY(180), rotY(270) };

    public static final Matrix3[] sideRotations = { /* 0, -Y, DOWN */ ident, /* 1, +Y, UP */ rotX(180),
    ...
    public final double[][] m = new double[][] { { 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 } };
