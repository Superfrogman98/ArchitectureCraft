...
public enum Shape {
    ...
    SlopeTileC2(100, "Slope C 2", Model("slope_c2"), Bilateral, 1, 2, 0xcf),
    SlopeTileC3(101, "Slope C 3", Model("slope_c3"), Bilateral, 1, 3, 0x0f),
    ...
    SlopeTileC1SE(108, "Slope C 1(Glow)", Model("slope_c1"), Bilateral, 1, 1, 0xff),
    SlopeTileC2SE(109, "Slope C 2(Glow)", Model("slope_c2"), Bilateral, 1, 2, 0xcf),
    SlopeTileC3SE(110, "Slope C 3(Glow)", Model("slope_c3"), Bilateral, 1, 3, 0x0f),
