...
public class BlockArchitecture<TE extends TileEntity> extends BlockContainer implements IBlockArchitecture {
    ...
    public Class getDefaultItemClass() {
        return ArchitectureItemBlock.class;
    }
    ...
    public TE getTileEntity(IBlockAccess world, BlockPos pos) {
        if (hasTileEntity()) return (TE) world.getTileEntity(pos.x, pos.y, pos.z);
        else return null;
    }
    ...
    public void onBlockAdded(World world, int x, int y, int z) {
        ...
        if (hasTileEntity(meta)) {
            ...
            if (te instanceof TileArchitecture teAC) teAC.onAddedToWorld();
        }
